...
class Strategy(object):
    ...
    def generate_signals(self):
        ...
        contaning the signals to go long, short or hold(1,-1,0)."""
...
class Portfolio(object):
    ...
    def generate_positions(self):
        """Provides the logic to determine how the portfolio positions are
        allocated on the basis of forecasting signals and available cash."""
        raise NotImplementedError("Should implement generate_position()!")
    ...
    def backtest_portfolio(self):
        ...
        functions."""
        raise NotImplementedError("Should implement backtest_portfolo()!")
